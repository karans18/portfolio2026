            ...
            <div className="flex flex-col">
              ...
              <div className="w-full flex justify-center px-4">
                <img
                  ...
                  className="lg:w-full w-[80%] max-h-[200px] object-contain rounded-xl shadow-2xl"
                />
              </div>
                ...
                <div className="flex gap-4 mt-6">
                  {selectedProject.github && (
                    <a
                      ...
                      className="w-1/2 bg-gray-800 hover:bg-purple-800 text-gray-300 px-4 py-2 rounded-xl text-sm lg:text-lg font-semibold text-center transition"
                    >
                      View Code
                    </a>
                  )}
